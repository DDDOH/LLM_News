...
LORA = True
DEBUG = True # if debug, use only few data
...
def plot_log(fig_file_path, data):
    ...
    plt.plot(data['epoch_rec'], data['test_accuracy_rec_all'], label='test_acc all')
    plt.plot(data['epoch_rec'], data['test_accuracy_rec_significant'], label='test_acc significant')
