...
SPLIT_ID = 5 # if 0, use original split, otherwise use new split
...
# sort the train and test data by test_id
...
if TRAINING_SIZE_TEST:
    ...
    plt.plot(ratio_ls
    , np.array(acc_sig) * 100, marker='o', linestyle='-', color='C2', label='Accuracy on Significant Subset')
