...
DIM = 3072 # Only useful for OpenAI, other models dimension are given in MODEL
ALGO = 'MLP' # MLP or Linear
...
if SPLIT_BY_TIME:
    ...
    if os.path.exists(os.path.join("Pure LLM - Embedding/saved_embedding", MODEL, "calibration.npy")):
        calibration = np.load(os.path.join("Pure LLM - Embedding/saved_embedding", MODEL, "calibration.npy"), allow_pickle=True)
